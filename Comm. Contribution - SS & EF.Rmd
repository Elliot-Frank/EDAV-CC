...
to arrows based on their magnitude - see below. Moreover, above the color bar we can 
...
arrow lengths and larger spacing allow longer arrow lengths. In other words, there
...
cross-sections are taken from in the 3D space. We recommend initially cross-sections 
at the mid-point of each direction and adjusting the exact slices as appropriate. 
