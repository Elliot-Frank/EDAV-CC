---
title: "Tutorial for Vector Fields in R"
...
tutorial, identifying the required components for vector graphs will be easier 
when handling these data sets in the future.
...
represent (eg m/s). For this example, we'll create a new data set with x_axis 
...
these additions as the analysis of these applications requires a deep knowledge of
